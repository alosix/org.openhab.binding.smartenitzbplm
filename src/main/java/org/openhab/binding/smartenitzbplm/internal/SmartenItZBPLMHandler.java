...
/**
 * The {@link SmartenItZBPLMHandler} is responsible for handling commands, which are
 * sent to one of the channels.
 *
 * @author Jason Powers - Initial contribution
 */
@NonNullByDefault
public class SmartenItZBPLMHandler extends BaseThingHandler {
    ...
    public void initialize() {
        ...
        config = getConfigAs(SmartenItZBPLMConfiguration.class);
