 ...
 */
public class SmartenitZBPLMThingTypeMatcher {
    private final Logger logger = LoggerFactory.getLogger(SmartenitZBPLMThingTypeMatcher.class);
    ...
    public ThingTypeUID matchThingType(Map<String, Object> properties) {
        ...
        return new ThingTypeUID(SmartenItZBPLMBindingConstants.BINDING_ID, matchedThingType);
    }
    ...
    public @NonNull Set<@NonNull ThingTypeUID> getSupportedThingTypeUIDs() {
        ...
        for (Entry<String, List<RequiredProperty>> thingProperties : discoveryProperties.entrySet()) {
            thingTypes.add(new ThingTypeUID(SmartenItZBPLMBindingConstants.BINDING_ID, thingProperties.getKey()));
        }
